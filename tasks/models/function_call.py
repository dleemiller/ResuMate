"""
From langchain:
    https://github.com/langchain-ai/langchain/blob/master/libs/langchain/langchain/utils/json_schema.py
"""
...
def convert_pydantic_to_openai_function(
    model: Type[BaseModel], function_name: str, function_description: str
) -> FunctionDescription:
...
def convert_pydantic_to_openai_tool(
    ...
    function = convert_pydantic_to_openai_function(
        model, function_name, function_description
    )
